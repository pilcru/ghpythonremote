...
if sys.platform == "cli":
    ...
    # This is only needed if the local is CPython and the remote is IronPython, doesn't really hurt otherwise
    _netref_factory_orig = rpyc.core.protocol.Connection._netref_factory
    _netref_factory_str = lambda self, id_pack: _netref_factory_orig(self, (str(id_pack[0]), id_pack[1], id_pack[2]))
